...
var (
	...
	ErrInvalidGroup               = errors.Normalize("invalid group settings, please check the group name and the number of resources", errors.RFCCodeText("PD:resourcemanager:ErrInvalidGroup"))
)
