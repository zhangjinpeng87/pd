...
func (s *evictSlowStoreScheduler) Cleanup(cluster sche.ClusterInformer) {
	s.cleanupEvictLeader(cluster)
}

func (s *evictSlowStoreScheduler) prepareEvictLeader(cluster sche.ClusterInformer, storeID uint64) error {
...
func (s *evictSlowStoreScheduler) cleanupEvictLeader(cluster sche.ClusterInformer) {
...
func (s *evictSlowStoreScheduler) schedulerEvictLeader(cluster sche.ClusterInformer) []*operator.Operator {
	return scheduleEvictLeaderBatch(s.GetName(), s.GetType(), cluster, s.conf, EvictLeaderBatchSize)
}

func (s *evictSlowStoreScheduler) IsScheduleAllowed(cluster sche.ClusterInformer) bool {
...
func (s *evictSlowStoreScheduler) Schedule(cluster sche.ClusterInformer, dryRun bool) ([]*operator.Operator, []plan.Plan) {
